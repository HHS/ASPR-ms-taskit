...
public enum CoreTranslationError implements ContractError {
    ...
    NULL_TRANSLATOR_ID("Null TranslatorId"), NULL_TRANSLATOR("Null Translator"),
    ...
    DUPLICATE_TRANSLATOR("Duplicate Translator"), MISSING_TRANSLATOR("Missing Translator: "),
    CIRCULAR_TRANSLATOR_DEPENDENCIES("Circular translator dependencies: "),
    NULL_INIT_CONSUMER("Null Initilizer Consumer"), NULL_DEPENDENCY("Null dependency"),
    DUPLICATE_DEPENDENCY("Duplicate Dependency"), NULL_PATH("Null Path"), DUPLICATE_INPUT_PATH("Duplicate Input Path"),
    INVALID_INPUT_PATH("The given input file path does not exist"), NULL_CLASS_REF("Null Class Ref"),
    ...
    DUPLICATE_CLASSREF_SCENARIO_PAIR("Duplicate ClassRef and Scenario Pair"), DUPLICATE_CLASSREF("Duplicate ClassRef"),
    UNKNOWN_CLASSREF("No object has been read in with the specified classRef"),
    NULL_TRANSLATION_SPEC("Null TranslationSpec"), NULL_TRANSLATION_SPEC_APP_CLASS("Null TranslationSpec App Class"),
